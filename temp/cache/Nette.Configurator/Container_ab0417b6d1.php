<?php
// source: E:\xamp\htdocs\azulgarweb\app/config/config.neon 
// source: E:\xamp\htdocs\azulgarweb\app/config/config.local.neon 

class Container_ab0417b6d1 extends Nette\DI\Container
{
	protected $meta = [
		'types' => [
	...
	{
		parent::__construct([
			'appDir' => 'E:\xamp\htdocs\azulgarweb\app',
			'wwwDir' => 'E:\xamp\htdocs\azulgarweb\www',
			'debugMode' => TRUE,
			'productionMode' => FALSE,
			'consoleMode' => FALSE,
			'tempDir' => 'E:\xamp\htdocs\azulgarweb\app/../temp',
		]);
	}
	...
	{
		$service = new Nette\Application\PresenterFactory(new Nette\Bridges\ApplicationDI\PresenterFactoryCallback($this, 5, 'E:\xamp\htdocs\azulgarweb\app/../temp/cache/Nette%5CBridges%5CApplicationDI%5CApplicationExtension'));
	...
	{
		$service = new Nette\Caching\Storages\SQLiteJournal('E:\xamp\htdocs\azulgarweb\app/../temp/cache/journal.s3db');
		return $service;
	}
	...
	{
		$service = new Nette\Caching\Storages\FileStorage('E:\xamp\htdocs\azulgarweb\app/../temp/cache',
	...
	{
		return new Container_ab0417b6d1_Nette_Bridges_ApplicationLatte_ILatteFactoryImpl_latte_latteFactory($this);
	}
...
final class Container_ab0417b6d1_Nette_Bridges_ApplicationLatte_ILatteFactoryImpl_latte_latteFactory implements Nette\Bridges\ApplicationLatte\ILatteFactory
{
	private $container;


	public function __construct(Container_ab0417b6d1 $container)
	{
	...
	public function create(): Latte\Engine
	{
		...
		$service->setTempDirectory('E:\xamp\htdocs\azulgarweb\app/../temp/cache/latte');
